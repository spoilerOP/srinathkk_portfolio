          ...
          <BlurFade delay={BLUR_FADE_DELAY * 13}>
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                These are my achievements, highlighting my dedication to cybersecurity and innovation. From identifying and responsibly reporting critical vulnerabilities in renowned organizations to showcasing my creative and technical expertise in global competitions{" "}
          ...
          <BlurFade delay={BLUR_FADE_DELAY * 16}>
            <div className="space-y-3">
              ...
              <p className="mx-auto max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                ...
                and I&apos;ll get back to you as soon as I can. Looking forward to connecting!
              </p>
            </div>
          </BlurFade>
        </div>
